      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt('return', (0, _utils.buildRules)(_this.config.rules, _extends({ validator: _this.options }, options)).then(function (builtRules) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              return _context2.abrupt('return', _lodash2.default.reduce(builtRules.split('|'), function (filtered, filter) {
