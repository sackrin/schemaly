...
var Allow = exports.Allow = function Allow(_ref) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt('return', (0, _utils.buildRoles)(_this.roles, _extends({ policy: _this.options }, options)));
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt('return', (0, _utils.buildScope)(_this.scope, _extends({ policy: _this.options }, options)));
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return (0, _utils.buildRoles)(_this.roles, options);

            case 2:
              forRoles = _context3.sent;
              _context3.next = 5;
              return (0, _utils.buildRoles)(roles, options);
            ...
            case 9:
              _context3.next = 11;
              return (0, _utils.buildScope)(_this.scope, options);

            case 11:
              forScopes = _context3.sent;
              _context3.next = 14;
              return (0, _utils.buildScope)(scope, options);
