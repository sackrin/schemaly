...
exports.GrantAllPolicies = undefined;
...
var GrantAllPolicies = exports.GrantAllPolicies = function GrantAllPolicies(_ref) {
  var policies = _ref.policies,
      options = _objectWithoutProperties(_ref, ['policies']);

  _classCallCheck(this, GrantAllPolicies);
...
exports.default = function (policies) {
  ...
  return new GrantAllPolicies(_extends({ policies: policies }, options));
};