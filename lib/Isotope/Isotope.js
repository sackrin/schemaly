...
var Isotope = exports.Isotope = function () {
  ...
  function Isotope(_ref) {
    var reactor = _ref.reactor,
        ...
        value = _ref.value,
        options = _objectWithoutProperties(_ref, ['reactor', 'nucleus', 'value']);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              _context5.next = 9;
              return (0, _.Isotopes)({ reactor: reactor, nuclei: nuclei, values: value }).hydrate(options);
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          ...
                          _context4.next = 3;
                          return (0, _.Isotopes)({ reactor: reactor, nuclei: nuclei, values: _value }).hydrate(options);
