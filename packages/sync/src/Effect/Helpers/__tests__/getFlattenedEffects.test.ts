...
describe('Effect/Helpers/getFlattenedEffects', () => {
  ...
  it('can flatten a simple set of fields', () => {
    const collider = Collision({
      model: fakeSchema,
      roles: ['user', 'admin'],
      scope: ['r', 'w'],
    });
    const fakeCollided = collider.with(fakeData).collide();
  ...
  it('can flatten a set of fields with a container field', () => {
    const collider = Collision({
      model: fakeSchema,
      roles: ['user', 'admin'],
      scope: ['r', 'w'],
  ...
  it('can flatten a set of fields with a collection field', () => {
    const collider = Collision({
      model: fakeSchema,
      roles: ['user', 'admin'],
      scope: ['r', 'w'],
