...
describe('Collider/Collision', () => {
  ...
  it('can simulate viewing a user as a guest', () => {
    ...
    fakeCollision.with(fakeDBRecord).collide();
    const dumped = fakeCollision.dump();
  ...
  it('can simulate updating a user as a owner', () => {
    ...
    fakeCollision
      ...
      .collide();
    fakeCollision.sanitize({});
    const validated = fakeCollision.validate({});
