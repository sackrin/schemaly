...
describe('Effect/Helpers/getFlattenedEffects', () => {
  ...
  it('can flatten a simple set of fields validations', () => {
    const collider = Collision({
      model: fakeSchema,
      roles: ['user', 'admin'],
      scope: ['r', 'w'],
    });
    const fakeCollided = collider
      .with({
        emails: [{}],
      })
      .collide();
    const fakeValidated = fakeCollided.validate({});
  ...
  it('can flatten a set of fields with a container field validation', () => {
    const collider = Collision({
      model: fakeSchema,
      roles: ['user', 'admin'],
      scope: ['r', 'w'],
  ...
  it('can flatten a set of fields validations with a container field validation', () => {
    const collider = Collision({
      model: fakeSchema,
      roles: ['user', 'admin'],
      scope: ['r', 'w'],
